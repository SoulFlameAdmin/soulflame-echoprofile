...
function calcEchoResult(answers, questions) {
  ...
  return {
    ...
    summary: `Р В РЎС›Р В Р вЂ Р В РЎвЂўР РЋР РЏР РЋРІР‚С™ Echo Р РЋРІР‚С™Р В РЎвЂР В РЎвЂ” Р В Р’Вµ ${echoType}. Compatibility Р РЋР РЏР В РўвЂР РЋР вЂљР В РЎвЂў: ${compatibility}%.`
  };
}
...
function explainTwinProblem(twin, events = []) {
  const errors = events.filter(e => {
    ...
    return txt.includes("error") || txt.includes("fail") || txt.includes("Р В РЎвЂ“Р РЋР вЂљР В Р’ВµР РЋРІвЂљВ¬");
  });

  if (!twin.echoType || twin.echoType === "Not profiled") {
    return "Twin-Р РЋР вЂ°Р РЋРІР‚С™ Р В РЎвЂўР РЋРІР‚В°Р В Р’Вµ Р В Р вЂ¦Р РЋР РЏР В РЎВР В Р’В° Р В Р’В·Р В Р’В°Р В Р вЂ Р РЋР вЂ°Р РЋР вЂљР РЋРІвЂљВ¬Р В Р’ВµР В Р вЂ¦ EchoProfile. Р В РЎСџР РЋР вЂљР В РЎвЂўР В Р’В±Р В Р’В»Р В Р’ВµР В РЎВР РЋР вЂ°Р РЋРІР‚С™ Р В Р вЂ¦Р В Р’Вµ Р В Р’Вµ Р В Р вЂ  Р РЋРІР‚РЋР В Р’В°Р РЋРІР‚С™Р В Р’В°, Р В Р’В° Р В Р вЂ  Р В Р’В»Р В РЎвЂР В РЎвЂ”Р РЋР С“Р В Р вЂ Р В Р’В°Р РЋРІР‚В°Р В Р’В° Р В РЎвЂР В РўвЂР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р В РЎвЂР РЋРІР‚РЋР В Р вЂ¦Р В РЎвЂўР РЋР С“Р РЋРІР‚С™.";
  }

  if (!process.env.OPENAI_API_KEY) {
    return "GPT API Р В РЎвЂќР В Р’В»Р РЋР вЂ№Р РЋРІР‚РЋ Р В Р’В»Р В РЎвЂР В РЎвЂ”Р РЋР С“Р В Р вЂ Р В Р’В°. Chat Р РЋР вЂљР В Р’В°Р В Р’В±Р В РЎвЂўР РЋРІР‚С™Р В РЎвЂ Р В Р вЂ Р РЋР вЂ°Р В Р вЂ  fallback Р РЋР вЂљР В Р’ВµР В Р’В¶Р В РЎвЂР В РЎВ, Р В Р вЂ¦Р В РЎвЂў Р РЋР вЂљР В Р’ВµР В Р’В°Р В Р’В»Р В Р вЂ¦Р В РЎвЂР РЋР РЏР РЋРІР‚С™ GPT Р В Р вЂ¦Р РЋР РЏР В РЎВР В Р’В° Р В РўвЂР В Р’В° Р В РЎвЂўР РЋРІР‚С™Р В РЎвЂ“Р В РЎвЂўР В Р вЂ Р В Р’В°Р РЋР вЂљР РЋР РЏ.";
  }

  if (errors.length) {
    return `Р В Р’ВР В РЎВР В Р’В° ${errors.length} Р В РЎвЂ”Р В РЎвЂўР РЋР С“Р В Р’В»Р В Р’ВµР В РўвЂР В Р вЂ¦Р В РЎвЂ error/fail Р РЋР С“Р РЋР вЂ°Р В Р’В±Р В РЎвЂР РЋРІР‚С™Р В РЎвЂР РЋР РЏ. Р В РЎСџР РЋР вЂљР В РЎвЂўР В Р вЂ Р В Р’ВµР РЋР вЂљР В РЎвЂ Р В РЎвЂ”Р В РЎвЂўР РЋР С“Р В Р’В»Р В Р’ВµР В РўвЂР В Р вЂ¦Р В РЎвЂР РЋРІР‚С™Р В Р’Вµ Р В РЎвЂќР В РЎвЂўР В РЎВР В Р’В°Р В Р вЂ¦Р В РўвЂР В РЎвЂ Р В РЎвЂ payload.`;
  }

  return "Р В РЎСљР РЋР РЏР В РЎВР В Р’В° Р В РЎвЂќР РЋР вЂљР В РЎвЂР РЋРІР‚С™Р В РЎвЂР РЋРІР‚РЋР В Р’ВµР В Р вЂ¦ Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР В Р’В±Р В Р’В»Р В Р’ВµР В РЎВ. Twin-Р РЋР вЂ°Р РЋРІР‚С™ Р В РЎвЂР В РЎВР В Р’В° Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР РЋРІР‚С›Р В РЎвЂР В Р’В» Р В РЎвЂ Р РЋР С“Р В РЎвЂР РЋР С“Р РЋРІР‚С™Р В Р’ВµР В РЎВР В Р’В°Р РЋРІР‚С™Р В Р’В° Р В РЎвЂР В Р’В·Р В РЎвЂ“Р В Р’В»Р В Р’ВµР В Р’В¶Р В РўвЂР В Р’В° Р В Р’В°Р В РЎвЂќР РЋРІР‚С™Р В РЎвЂР В Р вЂ Р В Р вЂ¦Р В Р’В°.";
}
...
app.get("/api/admin/system", (req, res) => {
  ...
  const priority = ["dimitar", "stere0metal360", "Р В РЎВР В РЎвЂР РЋРІР‚С™Р В РЎвЂќР В РЎвЂў", "mitko"];
  twins.sort((a, b) => {
...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    if (!apiKey) {
      const name = profile.name || "Р РЋРІР‚С™Р В РЎвЂ";
      const echoType = profile.echoType || profile.echo?.echoType || "EchoProfile Р В РЎвЂўР РЋРІР‚В°Р В Р’Вµ Р В Р вЂ¦Р В Р’Вµ Р В Р’Вµ Р В Р’В·Р В Р’В°Р В Р вЂ Р РЋР вЂ°Р РЋР вЂљР РЋРІвЂљВ¬Р В Р’ВµР В Р вЂ¦";
      return res.json({
        ok: true,
        version: "V83",
        localFallback: true,
        reply: `${name}, Р В Р’В»Р В РЎвЂўР В РЎвЂќР В Р’В°Р В Р’В»Р В Р вЂ¦Р В РЎвЂР РЋР РЏР РЋРІР‚С™ AI Echo Р РЋР вЂљР В Р’В°Р В Р’В±Р В РЎвЂўР РЋРІР‚С™Р В РЎвЂ. Р В Р’В Р В Р’ВµР В Р’В°Р В Р’В»Р В Р’ВµР В Р вЂ¦ GPT Р РЋРІР‚В°Р В Р’Вµ Р РЋРІР‚С™Р РЋР вЂљР РЋР вЂ°Р В РЎвЂ“Р В Р вЂ¦Р В Р’Вµ, Р В РЎвЂќР В РЎвЂўР В РЎвЂ“Р В Р’В°Р РЋРІР‚С™Р В РЎвЂў Р РЋР С“Р В Р’В»Р В РЎвЂўР В Р’В¶Р В РЎвЂР РЋРІвЂљВ¬ OPENAI_API_KEY. Р В РЎС›Р В Р’ВµР В РЎвЂќР РЋРЎвЂњР РЋРІР‚В° Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР РЋРІР‚С›Р В РЎвЂР В Р’В»: ${echoType}.`
      });
    }
    ...
    res.json({ ok: true, version: "V83", model, reply: data?.choices?.[0]?.message?.content || "Echo Р В Р вЂ¦Р В Р’Вµ Р В Р вЂ Р РЋР вЂ°Р РЋР вЂљР В Р вЂ¦Р В Р’В° Р В РЎвЂўР РЋРІР‚С™Р В РЎвЂ“Р В РЎвЂўР В Р вЂ Р В РЎвЂўР РЋР вЂљ." });
  } catch (err) {
...
function v85Problem(twin, relatedEvents) {
  ...
  const hasError = txt.includes("error") || txt.includes("fail") || txt.includes("Р С–РЎР‚Р ВµРЎв‚¬") || txt.includes("failed");

  if (!twin.echoType || twin.echoType === "Not profiled") {
    return "Twin-РЎР‰РЎвЂљ Р С•РЎвЂ°Р Вµ Р Р…РЎРЏР СР В° Р В·Р В°Р Р†РЎР‰РЎР‚РЎв‚¬Р ВµР Р… EchoProfile.";
  }

  if (hasError) {
    return "Р ВР СР В° error/fail РЎРѓРЎР‰Р В±Р С‘РЎвЂљР С‘РЎРЏ. Р СџРЎР‚Р С•Р Р†Р ВµРЎР‚Р С‘ lastCommands/errorEvents.";
  }

  if (!process.env.OPENAI_API_KEY) {
    return "OPENAI_API_KEY Р В»Р С‘Р С—РЎРѓР Р†Р В°. Chat Р Вµ Р Р†РЎР‰Р Р† fallback РЎР‚Р ВµР В¶Р С‘Р С.";
  }

  return "OK. Р СњРЎРЏР СР В° Р С”РЎР‚Р С‘РЎвЂљР С‘РЎвЂЎР ВµР Р… Р С—РЎР‚Р С•Р В±Р В»Р ВµР С.";
}
...
function v85BuildSystem() {
  ...
  const enriched = partsRaw.ordered.map(twin => {
    ...
    const errorEvents = relatedEvents.filter(e => {
      const txt = JSON.stringify(e).toLowerCase();
      return txt.includes("error") || txt.includes("fail") || txt.includes("Р С–РЎР‚Р ВµРЎв‚¬") || txt.includes("failed");
    });
  ...
  return {
    ...
    version: "V85",
    adminOrder: {
      one: "Р СљР С•РЎРЏРЎвЂљ Twin",
      two: "Р вЂ™РЎРѓР С‘РЎвЂЎР С”Р С‘ Twin-Р С•Р Р†Р Вµ / Connect for Talk",
      three: "Network / Bugs / Payments",
      rule: "Р СљР С•РЎРЏРЎвЂљ Twin Р Вµ Р Р†Р С‘Р Р…Р В°Р С–Р С‘ Р С—РЎР‰РЎР‚Р Р†Р С‘."
    },
    stats: {
...
function v87HealthScore(twin, ctx) {
  ...
  let label = "РЎР»Р°Р±Рѕ Р·РґСЂР°РІРµ";
  if (score >= 85) label = "РњРЅРѕРіРѕ РґРѕР±СЂРѕ Р·РґСЂР°РІРµ";
  else if (score >= 65) label = "Р”РѕР±СЂРѕ Р·РґСЂР°РІРµ";
  else if (score >= 45) label = "РЎСЂРµРґРЅРѕ Р·РґСЂР°РІРµ";
  ...
  return {
    ...
    factors,
    explanation: {
      memory: factors.memory ? "РёРјР° Р»РѕРєР°Р»РЅР° РїР°РјРµС‚/РїСЂРѕС„РёР»" : "Р»РёРїСЃРІР° СЃС‚Р°Р±РёР»РµРЅ РїСЂРѕС„РёР»",
      echoProfile: factors.echoProfile ? "EchoProfile Рµ РЅР°Р»РёС‡РµРЅ" : "EchoProfile Р»РёРїСЃРІР°",
      openai: factors.openai ? "OpenAI/GPT Рµ СЃРІСЉСЂР·Р°РЅ" : "OpenAI/GPT РЅРµ Рµ СЃРІСЉСЂР·Р°РЅ",
      supabase: factors.supabase ? "Supabase Рµ СЃРІСЉСЂР·Р°РЅ" : "Supabase РЅРµ Рµ СЃРІСЉСЂР·Р°РЅ",
      connectors: factors.connectors ? "РёРјР° connector-Рё" : "РЅСЏРјР° connector-Рё",
      twinPlus: factors.twinPlus ? "РёРјР° Twin+ / network РІСЂСЉР·РєРё" : "РЅСЏРјР° Twin+ РІСЂСЉР·РєРё",
      payments: factors.payments ? "РёРјР° РїР»Р°С‰Р°РЅРµ" : "РЅСЏРјР° Р·Р°РїРёСЃР°РЅРѕ РїР»Р°С‰Р°РЅРµ",
      events: factors.events ? "РёРјР° Р°РєС‚РёРІРЅРѕСЃС‚/events" : "РЅСЏРјР° Р°РєС‚РёРІРЅРѕСЃС‚",
      errors: factors.errors ? "РёРјР° РіСЂРµС€РєРё" : "РЅСЏРјР° Р·Р°РїРёСЃР°РЅРё РіСЂРµС€РєРё"
    }
  };
}
...
function v87BuildTwinHealthSystem() {
  ...
  const enriched = twins.map(twin => {
    ...
    const errorEvents = relatedEvents.filter(e => {
      const txt = JSON.stringify(e).toLowerCase();
      return txt.includes("error") || txt.includes("fail") || txt.includes("failed") || txt.includes("РіСЂРµС€");
    });
  ...
  return {
    ...
    globalHealth: {
      ...
      twins: enriched.length,
      label:
        globalScore >= 85 ? "РњРЅРѕРіРѕ РґРѕР±СЂРѕ РѕР±С‰Рѕ Р·РґСЂР°РІРµ" :
        globalScore >= 65 ? "Р”РѕР±СЂРѕ РѕР±С‰Рѕ Р·РґСЂР°РІРµ" :
        globalScore >= 45 ? "РЎСЂРµРґРЅРѕ РѕР±С‰Рѕ Р·РґСЂР°РІРµ" :
        "РЎР»Р°Р±Рѕ РѕР±С‰Рѕ Р·РґСЂР°РІРµ"
    },
    infrastructure: {
      openaiConfigured: Boolean(process.env.OPENAI_API_KEY),
      supabaseConfigured: Boolean(process.env.SUPABASE_URL && (process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_ANON_KEY)),
