...
.drawer .bigLogoBlock{display:none!important}.drawer{max-width:100vw!important}.drawerBody{padding:14px!important}.optionGrid{display:grid!important;grid-template-columns:1fr!important;gap:12px!important}.optionCard{display:grid!important;grid-template-columns:54px 1fr!important;align-items:center!important;gap:14px!important;min-height:92px!important;padding:16px!important;border-radius:24px!important;background:linear-gradient(180deg,rgba(255,255,255,.075),rgba(255,255,255,.028))!important;border:1px solid rgba(255,255,255,.12)!important;box-shadow:0 12px 34px rgba(0,0,0,.32)!important}.optionIcon{width:52px!important;height:52px!important;border-radius:18px!important;display:grid!important;place-items:center!important;font-size:27px!important;background:radial-gradient(circle at 25% 20%,rgba(255,255,255,.22),transparent 30%),linear-gradient(135deg,rgba(0,234,255,.32),rgba(124,60,255,.34),rgba(255,79,243,.24))!important;box-shadow:0 0 26px rgba(124,60,255,.22)!important}.optionText{display:grid!important;gap:5px!important;min-width:0!important}.optionText b{font-size:20px!important;line-height:1.05!important;color:#fff!important;letter-spacing:-.3px!important}.optionText span{font-size:14.5px!important;line-height:1.35!important;color:#bfc8e8!important}
