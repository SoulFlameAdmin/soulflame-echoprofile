...
const INLINE_PRIVACY_HTML = "\u003c!doctype html\u003e\n\u003chtml lang=\"bg\"\u003e\n\u003chead\u003e\n\u003cmeta charset=\"utf-8\"\u003e\n\u003cmeta name=\"viewport\" content=\"width=device-width,initial-scale=1,viewport-fit=cover\"\u003e\n\u003ctitle\u003ePrivacy Policy — SoulFlame AI Twin\u003c/title\u003e\n\u003cstyle\u003e\n:root{--bg0:#03040a;--bg1:#080b1f;--bg2:#111a46;--text:#f8f7ff;--soft:#b9c3e8;--muted:#7f8ab4;--line:rgba(255,255,255,.14);--cyan:#00eaff;--violet:#7c3cff;--pink:#ff4ff3;--gold:#ffd166;--shadow:0 28px 90px rgba(0,0,0,.42)}\n*{box-sizing:border-box}\nbody{margin:0;min-height:100vh;font-family:Arial,Helvetica,sans-serif;color:var(--text);background:radial-gradient(circle at 15% 8%,rgba(124,60,255,.30),transparent 32rem),radial-gradient(circle at 86% 12%,rgba(0,234,255,.18),transparent 30rem),linear-gradient(135deg,var(--bg0),var(--bg1) 46%,var(--bg2))}\n.wrap{width:min(980px,100%);margin:0 auto;padding:22px}\nnav{display:flex;justify-content:space-between;align-items:center;gap:14px;padding:12px;border:1px solid var(--line);background:rgba(6,8,20,.72);border-radius:24px;margin-bottom:18px}\n.brand{font-weight:950}\n.links{display:flex;gap:8px;flex-wrap:wrap}\na{color:white;text-decoration:none;background:rgba(255,255,255,.08);border:1px solid var(--line);border-radius:999px;padding:10px 12px;font-size:13px;font-weight:900}\n.card{border:1px solid var(--line);background:linear-gradient(180deg,rgba(255,255,255,.085),rgba(255,255,255,.045));border-radius:30px;padding:clamp(22px,4vw,42px);box-shadow:var(--shadow)}\nh1{margin:0 0 18px;font-size:clamp(38px,6vw,72px);line-height:.9;letter-spacing:-2.5px;background:linear-gradient(90deg,var(--cyan),#5ca8ff,var(--violet),var(--pink));-webkit-background-clip:text;background-clip:text;color:transparent}\nh2{margin-top:28px;font-size:24px}\np,li{color:var(--soft);line-height:1.65;font-size:16px}\n.note{border:1px solid rgba(255,209,102,.28);background:rgba(255,209,102,.08);color:#ffe7a8;padding:14px;border-radius:18px;margin:18px 0}\nfooter{color:var(--muted);text-align:center;font-size:13px;padding:26px 0 40px}\n@media(max-width:760px){nav{flex-direction:column;align-items:flex-start}}\n\u003c/style\u003e\n\u003c/head\u003e\n\u003cbody\u003e\n\u003cdiv class=\"wrap\"\u003e\n\u003cnav\u003e\n\u003cdiv class=\"brand\"\u003eAI Twin by SoulFlame\u003c/div\u003e\n\u003cdiv class=\"links\"\u003e\n\u003ca href=\"/\"\u003eHome\u003c/a\u003e\n\u003ca href=\"/privacy\"\u003ePrivacy\u003c/a\u003e\n\u003ca href=\"/terms\"\u003eTerms\u003c/a\u003e\n\u003ca href=\"/disclaimer\"\u003eDisclaimer\u003c/a\u003e\n\u003c/div\u003e\n\u003c/nav\u003e\n\u003cmain class=\"card\"\u003e\n\u003ch1\u003ePrivacy Policy\u003c/h1\u003e\n\u003cp\u003eSoulFlame AI Twin съхранява данните, които въвеждаш доброволно: име, контакт, цел, избрани сигнали, профил, заявки, payment request и unlock събития.\u003c/p\u003e\n\u003cdiv class=\"note\"\u003eSoulFlame AI Twin не е медицинска, психиатрична или терапевтична услуга.\u003c/div\u003e\n\u003ch2\u003eЗащо се събират данни\u003c/h2\u003e\n\u003cul\u003e\u003cli\u003eСъздаване на Mini AI Twin.\u003c/li\u003e\u003cli\u003eОбработка на Full AI Twin заявка.\u003c/li\u003e\u003cli\u003eИздаване на unlock code.\u003c/li\u003e\u003cli\u003eПодобряване на продукта чрез analytics events.\u003c/li\u003e\u003c/ul\u003e\n\u003ch2\u003eСъхранение\u003c/h2\u003e\n\u003cp\u003eДанните се пазят в Supabase проекта на SoulFlame Twins.\u003c/p\u003e\n\u003ch2\u003eКонтакт\u003c/h2\u003e\n\u003cp\u003eЗа премахване на данни: stere0metal360@gmail.com.\u003c/p\u003e\n\u003c/main\u003e\n\u003cfooter\u003eSoulFlame Twins · V45\u003c/footer\u003e\n\u003c/div\u003e\n\u003c/body\u003e\n\u003c/html\u003e";
const INLINE_TERMS_HTML = "\u003c!doctype html\u003e\n\u003chtml lang=\"bg\"\u003e\n\u003chead\u003e\n\u003cmeta charset=\"utf-8\"\u003e\n\u003cmeta name=\"viewport\" content=\"width=device-width,initial-scale=1,viewport-fit=cover\"\u003e\n\u003ctitle\u003eTerms — SoulFlame AI Twin\u003c/title\u003e\n\u003cstyle\u003e\n:root{--bg0:#03040a;--bg1:#080b1f;--bg2:#111a46;--text:#f8f7ff;--soft:#b9c3e8;--muted:#7f8ab4;--line:rgba(255,255,255,.14);--cyan:#00eaff;--violet:#7c3cff;--pink:#ff4ff3;--gold:#ffd166;--shadow:0 28px 90px rgba(0,0,0,.42)}\n*{box-sizing:border-box}\nbody{margin:0;min-height:100vh;font-family:Arial,Helvetica,sans-serif;color:var(--text);background:radial-gradient(circle at 15% 8%,rgba(124,60,255,.30),transparent 32rem),radial-gradient(circle at 86% 12%,rgba(0,234,255,.18),transparent 30rem),linear-gradient(135deg,var(--bg0),var(--bg1) 46%,var(--bg2))}\n.wrap{width:min(980px,100%);margin:0 auto;padding:22px}\nnav{display:flex;justify-content:space-between;align-items:center;gap:14px;padding:12px;border:1px solid var(--line);background:rgba(6,8,20,.72);border-radius:24px;margin-bottom:18px}\n.brand{font-weight:950}\n.links{display:flex;gap:8px;flex-wrap:wrap}\na{color:white;text-decoration:none;background:rgba(255,255,255,.08);border:1px solid var(--line);border-radius:999px;padding:10px 12px;font-size:13px;font-weight:900}\n.card{border:1px solid var(--line);background:linear-gradient(180deg,rgba(255,255,255,.085),rgba(255,255,255,.045));border-radius:30px;padding:clamp(22px,4vw,42px);box-shadow:var(--shadow)}\nh1{margin:0 0 18px;font-size:clamp(38px,6vw,72px);line-height:.9;letter-spacing:-2.5px;background:linear-gradient(90deg,var(--cyan),#5ca8ff,var(--violet),var(--pink));-webkit-background-clip:text;background-clip:text;color:transparent}\nh2{margin-top:28px;font-size:24px}\np,li{color:var(--soft);line-height:1.65;font-size:16px}\n.note{border:1px solid rgba(255,209,102,.28);background:rgba(255,209,102,.08);color:#ffe7a8;padding:14px;border-radius:18px;margin:18px 0}\nfooter{color:var(--muted);text-align:center;font-size:13px;padding:26px 0 40px}\n@media(max-width:760px){nav{flex-direction:column;align-items:flex-start}}\n\u003c/style\u003e\n\u003c/head\u003e\n\u003cbody\u003e\n\u003cdiv class=\"wrap\"\u003e\n\u003cnav\u003e\n\u003cdiv class=\"brand\"\u003eAI Twin by SoulFlame\u003c/div\u003e\n\u003cdiv class=\"links\"\u003e\n\u003ca href=\"/\"\u003eHome\u003c/a\u003e\n\u003ca href=\"/privacy\"\u003ePrivacy\u003c/a\u003e\n\u003ca href=\"/terms\"\u003eTerms\u003c/a\u003e\n\u003ca href=\"/disclaimer\"\u003eDisclaimer\u003c/a\u003e\n\u003c/div\u003e\n\u003c/nav\u003e\n\u003cmain class=\"card\"\u003e\n\u003ch1\u003eTerms of Use\u003c/h1\u003e\n\u003cp\u003eИзползвайки SoulFlame AI Twin, приемаш, че продуктът е MVP за самоанализ и креативна рефлексия.\u003c/p\u003e\n\u003ch2\u003eПлатени функции\u003c/h2\u003e\n\u003cp\u003eFull AI Twin може да се отключва чрез payment request, payment link, webhook или admin-generated unlock code.\u003c/p\u003e\n\u003ch2\u003eОтговорност\u003c/h2\u003e\n\u003cp\u003eНе използвай резултатите като медицинска, финансова, юридическа или психологическа диагноза.\u003c/p\u003e\n\u003c/main\u003e\n\u003cfooter\u003eSoulFlame Twins · V45\u003c/footer\u003e\n\u003c/div\u003e\n\u003c/body\u003e\n\u003c/html\u003e";
const INLINE_DISCLAIMER_HTML = "\u003c!doctype html\u003e\n\u003chtml lang=\"bg\"\u003e\n\u003chead\u003e\n\u003cmeta charset=\"utf-8\"\u003e\n\u003cmeta name=\"viewport\" content=\"width=device-width,initial-scale=1,viewport-fit=cover\"\u003e\n\u003ctitle\u003eDisclaimer — SoulFlame AI Twin\u003c/title\u003e\n\u003cstyle\u003e\n:root{--bg0:#03040a;--bg1:#080b1f;--bg2:#111a46;--text:#f8f7ff;--soft:#b9c3e8;--muted:#7f8ab4;--line:rgba(255,255,255,.14);--cyan:#00eaff;--violet:#7c3cff;--pink:#ff4ff3;--gold:#ffd166;--shadow:0 28px 90px rgba(0,0,0,.42)}\n*{box-sizing:border-box}\nbody{margin:0;min-height:100vh;font-family:Arial,Helvetica,sans-serif;color:var(--text);background:radial-gradient(circle at 15% 8%,rgba(124,60,255,.30),transparent 32rem),radial-gradient(circle at 86% 12%,rgba(0,234,255,.18),transparent 30rem),linear-gradient(135deg,var(--bg0),var(--bg1) 46%,var(--bg2))}\n.wrap{width:min(980px,100%);margin:0 auto;padding:22px}\nnav{display:flex;justify-content:space-between;align-items:center;gap:14px;padding:12px;border:1px solid var(--line);background:rgba(6,8,20,.72);border-radius:24px;margin-bottom:18px}\n.brand{font-weight:950}\n.links{display:flex;gap:8px;flex-wrap:wrap}\na{color:white;text-decoration:none;background:rgba(255,255,255,.08);border:1px solid var(--line);border-radius:999px;padding:10px 12px;font-size:13px;font-weight:900}\n.card{border:1px solid var(--line);background:linear-gradient(180deg,rgba(255,255,255,.085),rgba(255,255,255,.045));border-radius:30px;padding:clamp(22px,4vw,42px);box-shadow:var(--shadow)}\nh1{margin:0 0 18px;font-size:clamp(38px,6vw,72px);line-height:.9;letter-spacing:-2.5px;background:linear-gradient(90deg,var(--cyan),#5ca8ff,var(--violet),var(--pink));-webkit-background-clip:text;background-clip:text;color:transparent}\nh2{margin-top:28px;font-size:24px}\np,li{color:var(--soft);line-height:1.65;font-size:16px}\n.note{border:1px solid rgba(255,209,102,.28);background:rgba(255,209,102,.08);color:#ffe7a8;padding:14px;border-radius:18px;margin:18px 0}\nfooter{color:var(--muted);text-align:center;font-size:13px;padding:26px 0 40px}\n@media(max-width:760px){nav{flex-direction:column;align-items:flex-start}}\n\u003c/style\u003e\n\u003c/head\u003e\n\u003cbody\u003e\n\u003cdiv class=\"wrap\"\u003e\n\u003cnav\u003e\n\u003cdiv class=\"brand\"\u003eAI Twin by SoulFlame\u003c/div\u003e\n\u003cdiv class=\"links\"\u003e\n\u003ca href=\"/\"\u003eHome\u003c/a\u003e\n\u003ca href=\"/privacy\"\u003ePrivacy\u003c/a\u003e\n\u003ca href=\"/terms\"\u003eTerms\u003c/a\u003e\n\u003ca href=\"/disclaimer\"\u003eDisclaimer\u003c/a\u003e\n\u003c/div\u003e\n\u003c/nav\u003e\n\u003cmain class=\"card\"\u003e\n\u003ch1\u003eDisclaimer\u003c/h1\u003e\n\u003cdiv class=\"note\"\u003eSoulFlame AI Twin не заменя лекар, психолог, терапевт, юрист или финансов консултант.\u003c/div\u003e\n\u003cp\u003eAI Twin резултатите са интерпретативни и креативни. Те са за лична посока, не за диагноза.\u003c/p\u003e\n\u003ch2\u003eПри сериозни проблеми\u003c/h2\u003e\n\u003cp\u003eОбърни се към квалифициран специалист.\u003c/p\u003e\n\u003c/main\u003e\n\u003cfooter\u003eSoulFlame Twins · V45\u003c/footer\u003e\n\u003c/div\u003e\n\u003c/body\u003e\n\u003c/html\u003e";
...
async function autoCreatePaidUnlockCode(input = {}) {
  ...
  const paymentBody = {
    id: paymentId,
    status: "paid",
    offer: input.offer || "Full AI Twin by SoulFlame",
    amount: input.amount || "19.00 EUR",
    method: input.method || input.provider || "auto_webhook",
    name: input.name || (input.user && input.user.name) || "",
    contact: input.contact || input.email || (input.user && input.user.contact) || "",
  ...
  if (existingPayment) {
    const updated = await supabaseRequest("payments", {
      method: "PATCH",
  ...
  if (!codeRow) {
    const insertedCode = await supabaseRequest("unlock_codes", {
      ...
      body: {
        ...
        note: "Auto-generated after paid payment " + paymentId,
        used_at: null,
        used_by: null,
        profile_id: null,
  ...
  await insertEvent("auto_code_created", {
    paymentId,
    code,
    contact: paymentBody.contact,
    offer: paymentBody.offer,
    source: input.source || "auto_code",
    externalId: input.externalId || ""
  });
  ...
  return {
    ...
    codeRow,
    deliveryText:
      "Здравей! Плащането е потвърдено. Твоят Full AI Twin код е: " +
      code +
...
async function handleHealth(req, res) {
  ...
  sendJson(res, 200, {
    ...
    routes: [
      "/",
      "/admin", "/landing", "/payment-success", "/payment-cancel",
      "/test",
      "/privacy",
      "/terms",
      "/disclaimer",
      "/api/health", "/api/payment-config",
      "/api/event",
      "/api/profile",
      "/api/lead",
      "/api/payment-request",
...
async function handlePaymentConfig(req, res) {
  ...
  sendJson(res, 200, {
    ...
    webhooks: {
      genericWebhookConfigured: Boolean(genericSecret),
      stripeWebhookConfigured: Boolean(stripeSecret),
    ...
    envNeededIfMissing: {
      ...
      genericWebhook: genericSecret ? [] : ["PAYMENT_WEBHOOK_SECRET"],
      stripeWebhook: stripeSecret ? [] : ["STRIPE_WEBHOOK_SECRET"],
      email: resendKey ? [] : ["RESEND_API_KEY", "EMAIL_FROM"]
    },
    time: now()
  });
}
...
async function handleAdminEmail(req, res) {
  ...
  if (!to) {
    sendJson(res, 400, { ok: false, error: "Recipient email/contact is required." });
    return;
  }
  ...
  if (!response.ok) {
    await insertEvent("email_send_failed", { to, subject, response: text });
  ...
  await insertEvent("email_sent", { to, subject, provider: "resend", response: data });
...
function deepTraitInfo(key) {
  const map = {
    vision: {
      title: "Future Architect",
      power: "вижда посока преди другите да видят пътя",
      risk: "може да се изгуби в прекалено много възможности",
      action: "избери една визия и я превърни в 3 конкретни действия"
    },
    logic: {
      title: "Quantum System Builder",
      power: "превръща хаоса в структура, алгоритъм и план",
      risk: "може да анализира прекалено дълго преди да действа",
      action: "сложи срок и пусни първа версия, дори да не е идеална"
    },
    emotion: {
      title: "Emotional Mirror",
      power: "усеща хора, нюанси, напрежение и скрити сигнали",
      risk: "може да поема чужди емоции като свои",
      action: "разделяй фактите от усещането преди всяко важно решение"
    },
    action: {
      title: "Momentum Engine",
      power: "започва бързо и движи нещата напред",
      risk: "може да гори енергия без достатъчно посока",
      action: "вържи всяко действие към една главна цел"
    },
    social: {
      title: "Influence Twin",
      power: "влияе чрез думи, присъствие и правилно позициониране",
      risk: "може да се адаптира прекалено към очакванията на другите",
      action: "говори от ясна позиция, не от нужда да бъдеш харесан"
    },
    future: {
      title: "Future Self Twin",
      power: "мисли през версии на себе си и бъдещи сценарии",
      risk: "може да живее в бъдещето, вместо да строи днес",
      action: "всеки ден оставяй физическа следа от бъдещата версия"
    },
    deep: {
      title: "Subconscious Explorer",
      power: "вижда модели под повърхността и търси истинската причина",
      risk: "може да усложнява простите решения",
      action: "когато откриеш модел, веднага го превърни в нов навик"
    },
    creator: {
      title: "Creator Twin",
      power: "създава системи, продукти, истории и нови светове",
      risk: "може да започне 10 проекта и да завърши 1",
      action: "избери един продукт и го доведи до публичен резултат"
    }
  };
...
function buildDeepFullTwinReport(input = {}) {
  ...
  const futureMessage =
    name + ", твоят Future Twin казва: не чакай да станеш готов. " +
    "Ти се изграждаш чрез действие. Главната ти линия е, че " + first.power +
    ", а вторият ти двигател е, че " + second.power + ". " +
    "Когато ги комбинираш, ти не просто мислиш — строиш реалност.";
  ...
  return {
    ...
    fullReportText,
    generatedAt: now(),
    version: "V47_DEEP_FULL_TWIN_REPORT_ENGINE"
  };
}
...
async function handleFullReport(req, res) {
  ...
  await insertEvent("full_report_generated", {
    ...
    source: body.source || "api_full_report"
  });
...
async function handleUnlock(req, res) {
  ...
  if (!submittedCode) {
    sendJson(res, 400, { ok: false, error: "Missing unlock code." });
    return;
  }
  ...
  if (current.status === "used") {
    sendJson(res, 409, { ok: false, error: "Този код вече е използван.", code: current });
    return;
  }
...
async function handlePaymentConfirm(req, res) {
  ...
  if (!paymentId) {
    sendJson(res, 400, { ok: false, error: "paymentId required." });
    return;
  }
...
async function handleGenericPaymentWebhook(req, res) {
  ...
  const status = String(body.status || body.payment_status || body.sale_status || "paid").toLowerCase();

  if (!["paid", "completed", "success", "succeeded"].includes(status)) {
    await insertEvent("payment_webhook_ignored", { status, body });

    sendJson(res, 200, {
      ok: true,
      ignored: true,
      reason: "Payment not paid/completed.",
      status
    });
    return;
  }
  ...
  const result = await autoCreatePaidUnlockCode({
    ...
    name: body.name || body.full_name || body.customer_name || "",
    contact: body.contact || body.email || body.customer_email || body.purchaser_email || "",
    offer: body.offer || body.product_name || "Full AI Twin by SoulFlame",
    amount: body.amount || body.price || body.formatted_price || "19.00 EUR",
  ...
  sendJson(res, 200, Object.assign({ ok: true, webhook: "generic_payment" }, result));
}
...
async function handleStripeWebhook(req, res) {
  ...
  try {
    ...
    sendJson(res, 400, { ok: false, error: "Invalid Stripe JSON." });
    return;
  }
  ...
  const amount = amountTotal ? (Number(amountTotal) / 100).toFixed(2) + " " + currency : "19.00 EUR";
...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (req.method === "GET" && pathName === "/landing") {
      sendHtml(res, INLINE_LANDING_HTML);
      return;
    }
    if (req.method === "GET" && pathName === "/landing") {
      sendHtml(res, INLINE_LANDING_HTML);
    ...
    if (req.method === "GET" && pathName === "/payment-success") {
      sendHtml(res, INLINE_PAYMENT_SUCCESS_HTML);
      return;
    }

    if (req.method === "GET" && pathName === "/payment-cancel") {
      sendHtml(res, INLINE_PAYMENT_CANCEL_HTML);
      return;
    }
    ...
    if (req.method === "GET" && pathName === "/api/payment-config") {
      await handlePaymentConfig(req, res);
      return;
    }
    ...
    if (req.method === "POST" && pathName === "/api/admin/auto-code") {
      await handleAdminAutoCode(req, res);
      return;
    }

    if (req.method === "POST" && pathName === "/api/full-report") {
      await handleFullReport(req, res);
      return;
    }
    ...
    if (req.method === "POST" && pathName === "/api/webhook/payment") {
      await handleGenericPaymentWebhook(req, res);
      return;
    }
